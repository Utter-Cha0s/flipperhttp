...
```
https://github.com/earlephilhower/arduino-pico/releases/download/5.6.0/package_rp2040_index.json,https://github.com/Ameba-AIoT/ameba-arduino-d/raw/dev/Arduino_package/package_realtek_amebad_early_index.json,https://dl.espressif.com/dl/package_esp32_index.json
```
